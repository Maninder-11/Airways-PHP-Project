...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 p-0 travels-agency-banner-inner-wrapper">
                    <img src="images/hotel.jpg" alt="Reserve" />
  ...
  <div class="form-group">
    ...
    <select id="room-selection" class="form-control" name="room_preference" required>
        ...
        <option value="connecting">Delux</option>
        <option value="adjoining">Super Delux</option>
        <option value="adjacent">Suite</option>
    </select>
  </div>
  <hr>
  <div class="form-group">
...
<div class="form-group">
                            <button required="required" class="btn travels-agency-btn enquery-btn" name="submit" type="submit">Book Room</button>
                        </div>
</form>
                </div>
<script>
